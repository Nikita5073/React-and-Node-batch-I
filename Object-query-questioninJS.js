...
// console.log(useradata.length);

//Retrieve all documents where the role is "admin".

// const admins = useradata.filter((user) => user.role == "admin");
// console.log(admins);

//Find all documents where the role is "customer" and the username contains "Karamchandani".
// const k = useradata.filter((user) => user.role == "customer" && user.username.includes("Karamchandani"));
// console.log(k);

//Find all documents where the user's first name starts with "R".
const r = useradata.filter((user) => user.firstName.startsWith("R"));
console.log(r);